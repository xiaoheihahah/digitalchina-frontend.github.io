...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="效果图-1" tabindex="-1"><a class="header-anchor" href="#效果图-1" aria-hidden="true">#</a> 效果图：</h4><p><img src="`+o+'" alt="issue-form-template"></p>',7);function w(E,S){const a=l("ExternalLinkIcon");return d(),c("div",null,[p,e("p",null,[n("完整的 "),v,n(" 模板可以参考："),e("a",b,[n(".gitignore Node template"),i(a)])]),m,e("div",g,[h,e("p",null,[n("了解更多请参考："),e("a",k,[n("gitattributes"),i(a)])])]),x,e("div",f,[_,e("p",null,[n("对于普通模板，除了用 Markdown 自定义模板外，还可以使用 GitHub Website 直接选用标准的问题模板，详细图文步骤请参考："),e("a",y,[n("为仓库配置问题模板"),i(a)])])]),G])}const I=t(u,[["render",w],["__file","about-git.html.vue"]]);export{I as default};
